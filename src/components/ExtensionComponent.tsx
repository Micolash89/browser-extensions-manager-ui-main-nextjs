...
export default function ExtensionComponent({ 
  ...
  return (
    <section className="w-80 dark:bg-blue-900 bg-neutral-00 p-5 rounded-2xl border border-neutral-30">
      <div className="flex gap-4 items-start">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-neutral-40">{description}</p>
        </div>
      </div>
      ...
      <div className="flex justify-between mt-6">
        ...
        <label className="inline-flex items-center cursor-pointer">
          ...
          />
          <div className="relative w-11 h-6 bg-neutral-30 peer-focus:outline-none rounded-full peer peer-focus:ring-2 peer-focus:ring-red-300 dark:peer-focus:ring-red-800 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-red-600 
